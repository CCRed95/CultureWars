...
namespace CultureWars.Manager.Markup.Extensions
{
	...
	//public class MDBlendExtension2 : MarkupExtension
	//{
		...
		: MarkupExtension
	{
		...
		private readonly double _mixinOpacity;
		private readonly SolidColorBrush _mixedBrush;
